...
function graphqlHTTP(options) {
  ...
  return function (request, response) {
    ...
    return new Promise(function (resolve) {
      ...
      return new Promise(function (resolve) {
        resolve(typeof rootValue === 'function' ? rootValue({
          document: documentAST,
          variables: variables,
          operationName: operationName
        }) : rootValue);
      }).then(function (rootValueData) {
        // Perform the execution, reporting any errors creating the context.
        try {
          return (0, _graphql.execute)(schema, documentAST, rootValueData, context, variables, operationName);
        } catch (contextError) {
